...
| File | What |
|---|---|
| `switcher.json` | **The one list of apps.** Name, path, description, and since 2026-09-07 an optional `icon` — an absolute path to a MONOCHROME SVG that module serves, used as a CSS mask over the tile's text colour so it follows the theme (rux-ds `brand/README.md`, "App tile icons"). Adding a module is one entry |
