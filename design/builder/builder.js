/* ==========================================================================
   ...
   index.html in a folder beside design/ plus one switcher.json entry; until
...
async function downloadPage() {
  try {
    ...
    exportNotice('Downloaded', `${a.download} — put it beside the project's own index.html. Its paths already point at /design/.`);
  } catch (e) {
