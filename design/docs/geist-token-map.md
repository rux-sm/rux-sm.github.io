...
| `--rux-button-danger-primary` | `#e5484d` | `--ds-red-700 #f13342` | nearest |
| `--rux-button-danger-secondary` | `#e5484d` | `--ds-red-700 #f13342` | nearest |
| `--rux-button-danger-hover` | `#cd2b31` | `--ds-red-800 #e2162a` | nearest |
| `--rux-button-danger-active` | `#702326` | `--ds-red-400 #6f101b` | nearest |
