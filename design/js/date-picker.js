/* ==========================================================================
   Design — DATE PICKER (the --next variant: single, range, simple)
   --------------------------------------------------------------------------
   ...
   by Scheduler, whose week label is the control that should jump the
   ...
   THE INPUT MAY BE `hidden`, AND THAT NEEDS ONE RULE, WHICH Design NOW SHIPS.
   Scheduler asked for a picker whose value is read rather than shown,
   ...
   Caught by the regenerated table, 2026-09-11. Scheduler measured the live condition on
