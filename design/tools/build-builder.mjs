...
// would drift. `npm run generate`; regenerated by `npm run verify`.
//
                ...
                <div class="rux--stack-vertical rux--stack-scale-7">
                  ...
                  <div class="rux--stack-vertical rux--stack-scale-5">
                    <div class="rux--stack-vertical rux--stack-scale-3">
                      ...
                      <div class="rux--form__helper-text">The download goes beside the project's <code>index.html</code>, and its paths already point at <code>/design/</code>. The copy is the whole <code>&lt;main&gt;</code> element, so it REPLACES a page's main region rather than filling it.</div>
                    </div>
                    <div class="rux--stack-vertical rux--stack-scale-3">
