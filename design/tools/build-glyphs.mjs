...
const snapshot = {
  _: 'Carbon\'s own drawing of every glyph assets/icons.svg claims, keyed name@size. '
    + 'Generated by tools/build-glyphs.mjs from @carbon/icons and committed so check-glyphs '
...
if (process.argv.includes('--check')) {
  ...
  if (current !== fresh) {
    console.error('\n  data/carbon-glyphs.json is out of date — run `node tools/build-glyphs.mjs`\n');
    process.exit(1);
  }
