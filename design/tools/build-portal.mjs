...
// gates read: data/inventory.json, data/coverage.json and tools/lib/gates.mjs.
...
const componentDocs = json('data/component-docs.json').components;
...
// mistake data/component-docs.json exists to avoid.
...
<!-- THE CUSTOMIZATION LAYER, after css/rux.css and in this order, because
     ...
     css/rux-theme.css carries three blocks, [data-theme="geist-dark"],
     [data-theme="ant-dark"] and [data-theme="spotify-dark"], none of which
     this page matches -- it is data-theme="white" above. The point is
...
<!-- GENERATED by tools/build-portal.mjs — do not edit. Every figure is read
     from data/inventory.json, data/coverage.json, tools/lib/gates.mjs and the
...
${tile('Stylesheet', kbz(gzipSize), `${kb(cssSize)} raw · ${kb(minSize)} minified`)}
        ...
        <div class="rux--stack-vertical rux--stack-scale-5">
          ...
          <p>${COMPILED.size} of ${allComponents.length} compile into <code>css/rux.css</code>. Coverage is what the kitchen sink and templates actually exercise, ratcheted in <code>data/coverage.json</code>.</p>
