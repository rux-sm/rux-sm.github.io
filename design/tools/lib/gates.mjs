...
export const GATES = [
  ...
  },
  {
    ...
    kind: 'node',
    inVerify: true,
    catches: 'a `<use>` pointing at a symbol the sprite does not carry · a fragment referencing the sprite externally or a template referencing it bare · a sprite out of step with `build-icons.mjs`',
    ...
    reads: 'per-file',
    fileTargets: ROOTS,
    inputs: [...ROOTS, 'assets/icons.svg', 'tools/build-icons.mjs'],
  ...
  // on 2026-09-12: an app is a folder beside design/ now, started from a
