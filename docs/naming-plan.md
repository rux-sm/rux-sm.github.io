...
├── rux-backend/                             ├── backend/
├── rux-ui/            (old app)             ├── rux-ui/            (archived, untouched)
...
| :--- | :--- | :--- | :--- | :--- |
| Rux | `/` | `— Rux` | `rux--` | `site` |
| Design | `/design/` | `— Design` | `design-` (the DS itself stays `rux--`) | `design` |
...
- "Design" or "Design System" as the display name; `/design/` or `/ds/`.
