...
# Plan: roll the learning tool across the rest of the map

## Goal

Everything that waits until the first tile holds. `notes-learning-tool.md` is
the tile model and that first slice; this is the rest of the map, the whole
navigation, and what stops being a page. Nothing here starts before the slice
has been used and what it got wrong is written down.
