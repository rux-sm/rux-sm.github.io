/* ==========================================================================
   Notes — THE WALKTHROUGH NOTEPAD
   --------------------------------------------------------------------------
   Behaviour for a walkthrough page: a place to write down the value a step yields,
   ...
   walkthrough; nothing is sent anywhere, and the page says so beside the box.
   ...
   walkthrough text, never decides for itself which step yields a value, and never
