...
**Every app links `/rux-ds/` live** from the same repository, with no copy.
...
| Task | Command | Then |
|---|---|---|
| Run | `npm run serve` from the repository root, then `http://localhost:8640/rux-ds/` | open the sink, the portal, a template |
