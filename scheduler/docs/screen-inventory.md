...
| Trip editor, larger size | keep | A button beside the panel's close button swaps Carbon's small panel for its extra-large one, in front of the dimmed week, with each tab's sections in two columns; the choice is kept in this browser. |
