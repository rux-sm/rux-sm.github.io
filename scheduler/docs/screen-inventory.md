...
today, else the first. Its head's days button shows both weeks, widening the
pane from 20rem to 40rem so each day keeps its size, and the browser keeps that
choice.
