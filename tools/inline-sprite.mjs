...
//
//   node tools/inline-sprite.mjs                  the site's own pages: /, account/, login/, scheduler/, scheduler/share/, pixels/, sevens/
...
const SITE_DIRS = ['.', 'account', 'login', 'oauth/consent', 'scheduler', 'scheduler/share', 'pixels', 'sevens'];
